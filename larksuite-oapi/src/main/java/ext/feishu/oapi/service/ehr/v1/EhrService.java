...
package ext.feishu.oapi.service.ehr.v1;
...
import ext.feishu.oapi.service.ehr.v1.model.EmployeeListResult;
...
public class EhrService {
    ...
    public static class AttachmentGetReqCall extends ReqCaller<Object, OutputStream> {
        ...
        public Response<OutputStream> execute() throws Exception {
            ...
            Request<Object, OutputStream> request = Request.newRequest("/open-apis/ehr/v1/attachments/:token", "GET",
    ...
    public static class EmployeeListReqCall extends ReqCaller<Object, EmployeeListResult> {
        ...
        public Response<EmployeeListResult> execute() throws Exception {
            ...
            Request<Object, EmployeeListResult> request = Request.newRequest("/open-apis/ehr/v1/employees", "GET",
                    new AccessTokenType[]{AccessTokenType.Tenant},
                    null, this.result, this.optFns.toArray(new RequestOptFn[]{}));
