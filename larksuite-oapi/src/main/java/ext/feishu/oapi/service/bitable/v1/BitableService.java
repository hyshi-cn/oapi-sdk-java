...
package ext.feishu.oapi.service.bitable.v1;
...
import ext.feishu.oapi.service.bitable.v1.model.AppGetResult;
import ext.feishu.oapi.service.bitable.v1.model.AppTableBatchCreateReqBody;
import ext.feishu.oapi.service.bitable.v1.model.AppTableBatchCreateResult;
import ext.feishu.oapi.service.bitable.v1.model.AppTableBatchDeleteReqBody;
import ext.feishu.oapi.service.bitable.v1.model.AppTableCreateReqBody;
import ext.feishu.oapi.service.bitable.v1.model.AppTableCreateResult;
import ext.feishu.oapi.service.bitable.v1.model.AppTableField;
import ext.feishu.oapi.service.bitable.v1.model.AppTableFieldCreateResult;
import ext.feishu.oapi.service.bitable.v1.model.AppTableFieldDeleteResult;
import ext.feishu.oapi.service.bitable.v1.model.AppTableFieldListResult;
import ext.feishu.oapi.service.bitable.v1.model.AppTableFieldUpdateResult;
import ext.feishu.oapi.service.bitable.v1.model.AppTableListResult;
import ext.feishu.oapi.service.bitable.v1.model.AppTableRecord;
import ext.feishu.oapi.service.bitable.v1.model.AppTableRecordBatchCreateReqBody;
import ext.feishu.oapi.service.bitable.v1.model.AppTableRecordBatchCreateResult;
import ext.feishu.oapi.service.bitable.v1.model.AppTableRecordBatchDeleteReqBody;
import ext.feishu.oapi.service.bitable.v1.model.AppTableRecordBatchDeleteResult;
import ext.feishu.oapi.service.bitable.v1.model.AppTableRecordBatchUpdateReqBody;
import ext.feishu.oapi.service.bitable.v1.model.AppTableRecordBatchUpdateResult;
import ext.feishu.oapi.service.bitable.v1.model.AppTableRecordCreateResult;
import ext.feishu.oapi.service.bitable.v1.model.AppTableRecordGetResult;
import ext.feishu.oapi.service.bitable.v1.model.AppTableRecordListResult;
import ext.feishu.oapi.service.bitable.v1.model.AppTableRecordUpdateResult;
import ext.feishu.oapi.service.bitable.v1.model.AppTableView;
import ext.feishu.oapi.service.bitable.v1.model.AppTableViewCreateResult;
import ext.feishu.oapi.service.bitable.v1.model.AppTableViewListResult;
import ext.feishu.oapi.service.bitable.v1.model.DeleteRecord;
...
public class BitableService {
    ...
    public static class AppGetReqCall extends ReqCaller<Object, AppGetResult> {
        ...
        public Response<AppGetResult> execute() throws Exception {
            ...
            Request<Object, AppGetResult> request = Request.newRequest("/open-apis/bitable/v1/apps/:app_token", "GET",
    ...
    public static class AppTableListReqCall extends ReqCaller<Object, AppTableListResult> {
        ...
        public Response<AppTableListResult> execute() throws Exception {
            ...
            Request<Object, AppTableListResult> request = Request.newRequest("/open-apis/bitable/v1/apps/:app_token/tables", "GET",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    null, this.result, this.optFns.toArray(new RequestOptFn[]{}));
    ...
    public static class AppTableBatchCreateReqCall extends ReqCaller<AppTableBatchCreateReqBody, AppTableBatchCreateResult> {
        ...
        public Response<AppTableBatchCreateResult> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            this.optFns.add(Request.setQueryParams(this.queryParams));
            Request<AppTableBatchCreateReqBody, AppTableBatchCreateResult> request = Request.newRequest("/open-apis/bitable/v1/apps/:app_token/tables/batch_create", "POST",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
    ...
    public static class AppTableCreateReqCall extends ReqCaller<AppTableCreateReqBody, AppTableCreateResult> {
        ...
        public Response<AppTableCreateResult> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            this.optFns.add(Request.setQueryParams(this.queryParams));
            Request<AppTableCreateReqBody, AppTableCreateResult> request = Request.newRequest("/open-apis/bitable/v1/apps/:app_token/tables", "POST",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    this.body, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.appTables.service.config, request);
        }
    ...
    public static class AppTableDeleteReqCall extends ReqCaller<Object, EmptyData> {
        ...
        public Response<EmptyData> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            Request<Object, EmptyData> request = Request.newRequest("/open-apis/bitable/v1/apps/:app_token/tables/:table_id", "DELETE",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    null, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.appTables.service.config, request);
        }
    ...
    public static class AppTableBatchDeleteReqCall extends ReqCaller<AppTableBatchDeleteReqBody, EmptyData> {
        ...
        public Response<EmptyData> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            Request<AppTableBatchDeleteReqBody, EmptyData> request = Request.newRequest("/open-apis/bitable/v1/apps/:app_token/tables/batch_delete", "POST",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    this.body, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.appTables.service.config, request);
        }
    ...
    public static class AppTableFieldListReqCall extends ReqCaller<Object, AppTableFieldListResult> {
        ...
        public Response<AppTableFieldListResult> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            this.optFns.add(Request.setQueryParams(this.queryParams));
            Request<Object, AppTableFieldListResult> request = Request.newRequest("/open-apis/bitable/v1/apps/:app_token/tables/:table_id/fields", "GET",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    null, this.result, this.optFns.toArray(new RequestOptFn[]{}));
    ...
    public static class AppTableFieldCreateReqCall extends ReqCaller<AppTableField, AppTableFieldCreateResult> {
        ...
        public Response<AppTableFieldCreateResult> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            this.optFns.add(Request.setQueryParams(this.queryParams));
            Request<AppTableField, AppTableFieldCreateResult> request = Request.newRequest("/open-apis/bitable/v1/apps/:app_token/tables/:table_id/fields", "POST",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    this.body, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.appTableFields.service.config, request);
        }
    ...
    public static class AppTableFieldDeleteReqCall extends ReqCaller<Object, AppTableFieldDeleteResult> {
        ...
        public Response<AppTableFieldDeleteResult> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            Request<Object, AppTableFieldDeleteResult> request = Request.newRequest("/open-apis/bitable/v1/apps/:app_token/tables/:table_id/fields/:field_id", "DELETE",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    null, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.appTableFields.service.config, request);
        }
    ...
    public static class AppTableFieldUpdateReqCall extends ReqCaller<AppTableField, AppTableFieldUpdateResult> {
        ...
        public Response<AppTableFieldUpdateResult> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            Request<AppTableField, AppTableFieldUpdateResult> request = Request.newRequest("/open-apis/bitable/v1/apps/:app_token/tables/:table_id/fields/:field_id", "PUT",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    this.body, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.appTableFields.service.config, request);
        }
    ...
    public static class AppTableRecordBatchDeleteReqCall extends ReqCaller<AppTableRecordBatchDeleteReqBody, AppTableRecordBatchDeleteResult> {
        ...
        public Response<AppTableRecordBatchDeleteResult> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            Request<AppTableRecordBatchDeleteReqBody, AppTableRecordBatchDeleteResult> request = Request.newRequest("/open-apis/bitable/v1/apps/:app_token/tables/:table_id/records/batch_delete", "POST",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    this.body, this.result, this.optFns.toArray(new RequestOptFn[]{}));
    ...
    public static class AppTableRecordBatchCreateReqCall extends ReqCaller<AppTableRecordBatchCreateReqBody, AppTableRecordBatchCreateResult> {
        ...
        public Response<AppTableRecordBatchCreateResult> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            this.optFns.add(Request.setQueryParams(this.queryParams));
            Request<AppTableRecordBatchCreateReqBody, AppTableRecordBatchCreateResult> request = Request.newRequest("/open-apis/bitable/v1/apps/:app_token/tables/:table_id/records/batch_create", "POST",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    this.body, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.appTableRecords.service.config, request);
        }
    ...
    public static class AppTableRecordGetReqCall extends ReqCaller<Object, AppTableRecordGetResult> {
        ...
        public Response<AppTableRecordGetResult> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            this.optFns.add(Request.setQueryParams(this.queryParams));
            Request<Object, AppTableRecordGetResult> request = Request.newRequest("/open-apis/bitable/v1/apps/:app_token/tables/:table_id/records/:record_id", "GET",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    null, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.appTableRecords.service.config, request);
        }
    ...
    public static class AppTableRecordUpdateReqCall extends ReqCaller<AppTableRecord, AppTableRecordUpdateResult> {
        ...
        public Response<AppTableRecordUpdateResult> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            this.optFns.add(Request.setQueryParams(this.queryParams));
            Request<AppTableRecord, AppTableRecordUpdateResult> request = Request.newRequest("/open-apis/bitable/v1/apps/:app_token/tables/:table_id/records/:record_id", "PUT",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    this.body, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.appTableRecords.service.config, request);
        }
    ...
    public static class AppTableRecordDeleteReqCall extends ReqCaller<Object, DeleteRecord> {
        ...
        public Response<DeleteRecord> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            Request<Object, DeleteRecord> request = Request.newRequest("/open-apis/bitable/v1/apps/:app_token/tables/:table_id/records/:record_id", "DELETE",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    null, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.appTableRecords.service.config, request);
        }
    ...
    public static class AppTableRecordListReqCall extends ReqCaller<Object, AppTableRecordListResult> {
        ...
        public Response<AppTableRecordListResult> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            this.optFns.add(Request.setQueryParams(this.queryParams));
            Request<Object, AppTableRecordListResult> request = Request.newRequest("/open-apis/bitable/v1/apps/:app_token/tables/:table_id/records", "GET",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    null, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.appTableRecords.service.config, request);
        }
    ...
    public static class AppTableRecordBatchUpdateReqCall extends ReqCaller<AppTableRecordBatchUpdateReqBody, AppTableRecordBatchUpdateResult> {
        ...
        public Response<AppTableRecordBatchUpdateResult> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            this.optFns.add(Request.setQueryParams(this.queryParams));
            Request<AppTableRecordBatchUpdateReqBody, AppTableRecordBatchUpdateResult> request = Request.newRequest("/open-apis/bitable/v1/apps/:app_token/tables/:table_id/records/batch_update", "POST",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    this.body, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.appTableRecords.service.config, request);
        }
    ...
    public static class AppTableRecordCreateReqCall extends ReqCaller<AppTableRecord, AppTableRecordCreateResult> {
        ...
        public Response<AppTableRecordCreateResult> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            this.optFns.add(Request.setQueryParams(this.queryParams));
            Request<AppTableRecord, AppTableRecordCreateResult> request = Request.newRequest("/open-apis/bitable/v1/apps/:app_token/tables/:table_id/records", "POST",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    this.body, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.appTableRecords.service.config, request);
        }
    ...
    public static class AppTableViewCreateReqCall extends ReqCaller<AppTableView, AppTableViewCreateResult> {
        ...
        public Response<AppTableViewCreateResult> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            Request<AppTableView, AppTableViewCreateResult> request = Request.newRequest("/open-apis/bitable/v1/apps/:app_token/tables/:table_id/views", "POST",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    this.body, this.result, this.optFns.toArray(new RequestOptFn[]{}));
    ...
    public static class AppTableViewDeleteReqCall extends ReqCaller<Object, EmptyData> {
        ...
        public Response<EmptyData> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            Request<Object, EmptyData> request = Request.newRequest("/open-apis/bitable/v1/apps/:app_token/tables/:table_id/views/:view_id", "DELETE",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    null, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.appTableViews.service.config, request);
        }
    ...
    public static class AppTableViewListReqCall extends ReqCaller<Object, AppTableViewListResult> {
        ...
        public Response<AppTableViewListResult> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            this.optFns.add(Request.setQueryParams(this.queryParams));
            Request<Object, AppTableViewListResult> request = Request.newRequest("/open-apis/bitable/v1/apps/:app_token/tables/:table_id/views", "GET",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    null, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.appTableViews.service.config, request);
        }
