...
package ext.feishu.oapi.service.drive.v1;
...
import ext.feishu.oapi.service.drive.v1.model.FileComment;
import ext.feishu.oapi.service.drive.v1.model.FileCommentListResult;
import ext.feishu.oapi.service.drive.v1.model.FileCommentPatchReqBody;
import ext.feishu.oapi.service.drive.v1.model.FileCommentReplyUpdateReqBody;
import ext.feishu.oapi.service.drive.v1.model.FileDeletedEvent;
import ext.feishu.oapi.service.drive.v1.model.FileEditEvent;
import ext.feishu.oapi.service.drive.v1.model.FilePermissionMemberAddedEvent;
import ext.feishu.oapi.service.drive.v1.model.FilePermissionMemberRemovedEvent;
import ext.feishu.oapi.service.drive.v1.model.FileReadEvent;
import ext.feishu.oapi.service.drive.v1.model.FileStatisticsGetResult;
import ext.feishu.oapi.service.drive.v1.model.FileTitleUpdatedEvent;
import ext.feishu.oapi.service.drive.v1.model.FileTrashedEvent;
import ext.feishu.oapi.service.drive.v1.model.FileUploadAllResult;
import ext.feishu.oapi.service.drive.v1.model.FileUploadFinishReqBody;
import ext.feishu.oapi.service.drive.v1.model.FileUploadFinishResult;
import ext.feishu.oapi.service.drive.v1.model.FileUploadInfo;
import ext.feishu.oapi.service.drive.v1.model.FileUploadPrepareResult;
import ext.feishu.oapi.service.drive.v1.model.ImportTask;
import ext.feishu.oapi.service.drive.v1.model.ImportTaskCreateResult;
import ext.feishu.oapi.service.drive.v1.model.ImportTaskGetResult;
import ext.feishu.oapi.service.drive.v1.model.MediaBatchGetTmpDownloadUrlResult;
import ext.feishu.oapi.service.drive.v1.model.MediaUploadAllResult;
import ext.feishu.oapi.service.drive.v1.model.MediaUploadFinishReqBody;
import ext.feishu.oapi.service.drive.v1.model.MediaUploadFinishResult;
import ext.feishu.oapi.service.drive.v1.model.MediaUploadInfo;
import ext.feishu.oapi.service.drive.v1.model.MediaUploadPrepareResult;
import ext.feishu.oapi.service.drive.v1.model.Member;
import ext.feishu.oapi.service.drive.v1.model.PermissionMemberCreateResult;
import ext.feishu.oapi.service.drive.v1.model.PermissionMemberUpdateResult;
import ext.feishu.oapi.service.drive.v1.model.PermissionPublic;
import ext.feishu.oapi.service.drive.v1.model.PermissionPublicPatchResult;
...
public class DriveService {
    ...
    public static class FileUploadFinishReqCall extends ReqCaller<FileUploadFinishReqBody, FileUploadFinishResult> {
        ...
        public Response<FileUploadFinishResult> execute() throws Exception {
            Request<FileUploadFinishReqBody, FileUploadFinishResult> request = Request.newRequest("/open-apis/drive/v1/files/upload_finish", "POST",
    ...
    public static class FileUploadPrepareReqCall extends ReqCaller<FileUploadInfo, FileUploadPrepareResult> {
        ...
        public Response<FileUploadPrepareResult> execute() throws Exception {
            Request<FileUploadInfo, FileUploadPrepareResult> request = Request.newRequest("/open-apis/drive/v1/files/upload_prepare", "POST",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    this.body, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.files.service.config, request);
        }
    ...
    public static class FileUploadAllReqCall extends ReqCaller<FormData, FileUploadAllResult> {
        ...
        public Response<FileUploadAllResult> execute() throws Exception {
            Request<FormData, FileUploadAllResult> request = Request.newRequest("/open-apis/drive/v1/files/upload_all", "POST",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    this.body, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.files.service.config, request);
        }
    ...
    public static class FileUploadPartReqCall extends ReqCaller<FormData, EmptyData> {
        ...
        public Response<EmptyData> execute() throws Exception {
            Request<FormData, EmptyData> request = Request.newRequest("/open-apis/drive/v1/files/upload_part", "POST",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    this.body, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.files.service.config, request);
        }
    ...
    public static class FileDownloadReqCall extends ReqCaller<Object, OutputStream> {
        ...
        public Response<OutputStream> execute() throws Exception {
            ...
            Request<Object, OutputStream> request = Request.newRequest("/open-apis/drive/v1/files/:file_token/download", "GET",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
    ...
    public static class FileSubscribeReqCall extends ReqCaller<Object, EmptyData> {
        ...
        public Response<EmptyData> execute() throws Exception {
            ...
            Request<Object, EmptyData> request = Request.newRequest("/open-apis/drive/v1/files/:file_token/subscribe", "POST",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    null, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.files.service.config, request);
        }
    ...
    public static class FileCommentCreateReqCall extends ReqCaller<FileComment, FileComment> {
        ...
        public Response<FileComment> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            this.optFns.add(Request.setQueryParams(this.queryParams));
            Request<FileComment, FileComment> request = Request.newRequest("/open-apis/drive/v1/files/:file_token/comments", "POST",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    this.body, this.result, this.optFns.toArray(new RequestOptFn[]{}));
    ...
    public static class FileCommentGetReqCall extends ReqCaller<Object, FileComment> {
        ...
        public Response<FileComment> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            this.optFns.add(Request.setQueryParams(this.queryParams));
            Request<Object, FileComment> request = Request.newRequest("/open-apis/drive/v1/files/:file_token/comments/:comment_id", "GET",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    null, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.fileComments.service.config, request);
        }
    ...
    public static class FileCommentListReqCall extends ReqCaller<Object, FileCommentListResult> {
        ...
        public Response<FileCommentListResult> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            this.optFns.add(Request.setQueryParams(this.queryParams));
            Request<Object, FileCommentListResult> request = Request.newRequest("/open-apis/drive/v1/files/:file_token/comments", "GET",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    null, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.fileComments.service.config, request);
        }
    ...
    public static class FileCommentPatchReqCall extends ReqCaller<FileCommentPatchReqBody, EmptyData> {
        ...
        public Response<EmptyData> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            this.optFns.add(Request.setQueryParams(this.queryParams));
            Request<FileCommentPatchReqBody, EmptyData> request = Request.newRequest("/open-apis/drive/v1/files/:file_token/comments/:comment_id", "PATCH",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    this.body, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.fileComments.service.config, request);
        }
    ...
    public static class FileCommentReplyUpdateReqCall extends ReqCaller<FileCommentReplyUpdateReqBody, EmptyData> {
        ...
        public Response<EmptyData> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            this.optFns.add(Request.setQueryParams(this.queryParams));
            Request<FileCommentReplyUpdateReqBody, EmptyData> request = Request.newRequest("/open-apis/drive/v1/files/:file_token/comments/:comment_id/replies/:reply_id", "PUT",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    this.body, this.result, this.optFns.toArray(new RequestOptFn[]{}));
    ...
    public static class FileCommentReplyDeleteReqCall extends ReqCaller<Object, EmptyData> {
        ...
        public Response<EmptyData> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            this.optFns.add(Request.setQueryParams(this.queryParams));
            Request<Object, EmptyData> request = Request.newRequest("/open-apis/drive/v1/files/:file_token/comments/:comment_id/replies/:reply_id", "DELETE",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    null, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.fileCommentReplys.service.config, request);
        }
    ...
    public static class ImportTaskCreateReqCall extends ReqCaller<ImportTask, ImportTaskCreateResult> {
        ...
        public Response<ImportTaskCreateResult> execute() throws Exception {
            Request<ImportTask, ImportTaskCreateResult> request = Request.newRequest("/open-apis/drive/v1/import_tasks", "POST",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    this.body, this.result, this.optFns.toArray(new RequestOptFn[]{}));
    ...
    public static class ImportTaskGetReqCall extends ReqCaller<Object, ImportTaskGetResult> {
        ...
        public Response<ImportTaskGetResult> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            Request<Object, ImportTaskGetResult> request = Request.newRequest("/open-apis/drive/v1/import_tasks/:ticket", "GET",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    null, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.importTasks.service.config, request);
        }
    ...
    public static class MediaUploadPartReqCall extends ReqCaller<FormData, EmptyData> {
        ...
        @Override
        public Response<EmptyData> execute() throws Exception {
            Request<FormData, EmptyData> request = Request.newRequest("/open-apis/drive/v1/medias/upload_part", "POST",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    this.body, this.result, this.optFns.toArray(new RequestOptFn[]{}));
    ...
    public static class MediaUploadAllReqCall extends ReqCaller<FormData, MediaUploadAllResult> {
        ...
        public Response<MediaUploadAllResult> execute() throws Exception {
            Request<FormData, MediaUploadAllResult> request = Request.newRequest("/open-apis/drive/v1/medias/upload_all", "POST",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    this.body, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.medias.service.config, request);
        }
    ...
    public static class MediaUploadFinishReqCall extends ReqCaller<MediaUploadFinishReqBody, MediaUploadFinishResult> {
        ...
        public Response<MediaUploadFinishResult> execute() throws Exception {
            Request<MediaUploadFinishReqBody, MediaUploadFinishResult> request = Request.newRequest("/open-apis/drive/v1/medias/upload_finish", "POST",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    this.body, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.medias.service.config, request);
        }
    ...
    public static class MediaUploadPrepareReqCall extends ReqCaller<MediaUploadInfo, MediaUploadPrepareResult> {
        ...
        public Response<MediaUploadPrepareResult> execute() throws Exception {
            Request<MediaUploadInfo, MediaUploadPrepareResult> request = Request.newRequest("/open-apis/drive/v1/medias/upload_prepare", "POST",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    this.body, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.medias.service.config, request);
        }
    ...
    public static class MediaBatchGetTmpDownloadUrlReqCall extends ReqCaller<Object, MediaBatchGetTmpDownloadUrlResult> {
        ...
        public Response<MediaBatchGetTmpDownloadUrlResult> execute() throws Exception {
            this.optFns.add(Request.setQueryParams(this.queryParams));
            Request<Object, MediaBatchGetTmpDownloadUrlResult> request = Request.newRequest("/open-apis/drive/v1/medias/batch_get_tmp_download_url", "GET",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    null, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.medias.service.config, request);
        }
    ...
    public static class MediaDownloadReqCall extends ReqCaller<Object, OutputStream> {
        ...
        public Response<OutputStream> execute() throws Exception {
            ...
            this.optFns.add(Request.setQueryParams(this.queryParams));
            this.optFns.add(Request.setResponseStream());
            Request<Object, OutputStream> request = Request.newRequest("/open-apis/drive/v1/medias/:file_token/download", "GET",
                    new AccessTokenType[]{AccessTokenType.User, AccessTokenType.Tenant},
                    null, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.medias.service.config, request);
        }
    ...
    public static class PermissionMemberCreateReqCall extends ReqCaller<Member, PermissionMemberCreateResult> {
        ...
        public Response<PermissionMemberCreateResult> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            this.optFns.add(Request.setQueryParams(this.queryParams));
            Request<Member, PermissionMemberCreateResult> request = Request.newRequest("/open-apis/drive/v1/permissions/:token/members", "POST",
    ...
    public static class PermissionMemberDeleteReqCall extends ReqCaller<Object, EmptyData> {
        ...
        public Response<EmptyData> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            this.optFns.add(Request.setQueryParams(this.queryParams));
            Request<Object, EmptyData> request = Request.newRequest("/open-apis/drive/v1/permissions/:token/members/:member_id", "DELETE",
                    new AccessTokenType[]{AccessTokenType.Tenant, AccessTokenType.User},
                    null, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.permissionMembers.service.config, request);
        }
    ...
    public static class PermissionMemberUpdateReqCall extends ReqCaller<Member, PermissionMemberUpdateResult> {
        ...
        public Response<PermissionMemberUpdateResult> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            this.optFns.add(Request.setQueryParams(this.queryParams));
            Request<Member, PermissionMemberUpdateResult> request = Request.newRequest("/open-apis/drive/v1/permissions/:token/members/:member_id", "PUT",
                    new AccessTokenType[]{AccessTokenType.Tenant, AccessTokenType.User},
                    this.body, this.result, this.optFns.toArray(new RequestOptFn[]{}));
            return Api.send(this.permissionMembers.service.config, request);
        }
    ...
    public static class PermissionPublicPatchReqCall extends ReqCaller<PermissionPublic, PermissionPublicPatchResult> {
        ...
        public Response<PermissionPublicPatchResult> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            this.optFns.add(Request.setQueryParams(this.queryParams));
            Request<PermissionPublic, PermissionPublicPatchResult> request = Request.newRequest("/open-apis/drive/v1/permissions/:token/public", "PATCH",
                    new AccessTokenType[]{AccessTokenType.Tenant, AccessTokenType.User},
                    this.body, this.result, this.optFns.toArray(new RequestOptFn[]{}));
    ...
    public static class FileStatisticsGetReqCall extends ReqCaller<Object, FileStatisticsGetResult> {
        ...
        public Response<FileStatisticsGetResult> execute() throws Exception {
            this.optFns.add(Request.setPathParams(this.pathParams));
            this.optFns.add(Request.setQueryParams(this.queryParams));
            Request<Object, FileStatisticsGetResult> request = Request.newRequest("/open-apis/drive/v1/files/:file_token/statistics", "GET",
                    new AccessTokenType[]{AccessTokenType.Tenant, AccessTokenType.User},
                    null, this.result, this.optFns.toArray(new RequestOptFn[]{}));
