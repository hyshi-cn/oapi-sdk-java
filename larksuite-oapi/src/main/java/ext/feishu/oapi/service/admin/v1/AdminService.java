...
package ext.feishu.oapi.service.admin.v1;
...
import ext.feishu.oapi.service.admin.v1.model.AdminDeptStatListResult;
import ext.feishu.oapi.service.admin.v1.model.AdminUserStatListResult;
...
public class AdminService {
    ...
    public static class AdminDeptStatListReqCall extends ReqCaller<Object, AdminDeptStatListResult> {
        ...
        public Response<AdminDeptStatListResult> execute() throws Exception {
            ...
            Request<Object, AdminDeptStatListResult> request = Request.newRequest("/open-apis/admin/v1/admin_dept_stats", "GET",
    ...
    public static class AdminUserStatListReqCall extends ReqCaller<Object, AdminUserStatListResult> {
        ...
        public Response<AdminUserStatListResult> execute() throws Exception {
            this.optFns.add(Request.setQueryParams(this.queryParams));
            Request<Object, AdminUserStatListResult> request = Request.newRequest("/open-apis/admin/v1/admin_user_stats", "GET",
                    new AccessTokenType[]{AccessTokenType.Tenant},
                    null, this.result, this.optFns.toArray(new RequestOptFn[]{}));
