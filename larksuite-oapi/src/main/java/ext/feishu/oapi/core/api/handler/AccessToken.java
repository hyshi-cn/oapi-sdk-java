...
import ext.feishu.oapi.core.api.exception.AccessTokenObtainException;
import ext.feishu.oapi.core.api.exception.AppTicketIsEmptyException;
import ext.feishu.oapi.core.api.request.BaseRequest;
import ext.feishu.oapi.core.api.request.Request;
import ext.feishu.oapi.core.api.response.Body;
import ext.feishu.oapi.core.api.token.AppAccessToken;
import ext.feishu.oapi.core.api.token.ISVAppAccessTokenReq;
import ext.feishu.oapi.core.api.token.ISVTenantAccessTokenReq;
import ext.feishu.oapi.core.api.token.InternalAccessTokenReq;
import ext.feishu.oapi.core.api.token.TenantAccessToken;
...
public class AccessToken {
    ...
    public static void signApp(Context ctx, ext.feishu.oapi.okhttp3_14.Request.Builder httpRequestBuilder) throws Exception {
        BaseRequest base = BaseRequest.byContext(ctx);
        Config config = Config.ByCtx(ctx);
        if (!base.isRetry()) {
    ...
    public static void signTenant(Context ctx, ext.feishu.oapi.okhttp3_14.Request.Builder httpRequestBuilder) throws Exception {
        BaseRequest base = BaseRequest.byContext(ctx);
        Config config = Config.ByCtx(ctx);
    ...
    public static void signUser(Context ctx, ext.feishu.oapi.okhttp3_14.Request.Builder httpRequestBuilder) {
        BaseRequest base = BaseRequest.byContext(ctx);
    ...
    private static void sign(ext.feishu.oapi.okhttp3_14.Request.Builder httpRequestBuilder, String token) {
