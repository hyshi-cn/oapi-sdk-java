package ext.feishu.oapi.core.api.request;

import ext.feishu.oapi.core.api.AccessTokenType;
import ext.feishu.oapi.core.api.request.requestoptfn.NotDataField;
import ext.feishu.oapi.core.api.request.requestoptfn.PathParams;
import ext.feishu.oapi.core.api.request.requestoptfn.QueryParams;
import ext.feishu.oapi.core.api.request.requestoptfn.ResponseStream;
import ext.feishu.oapi.core.api.request.requestoptfn.SupportLongDatatype;
import ext.feishu.oapi.core.api.request.requestoptfn.TenantKey;
import ext.feishu.oapi.core.api.request.requestoptfn.Timeout;
...
public class Request<I, O> extends BaseRequest<I, O> {
    ...
    private ext.feishu.oapi.okhttp3_14.Request.Builder httpRequestBuilder;
    ...
    private ext.feishu.oapi.core.api.response.Response<O> response;
    ...
    public ext.feishu.oapi.okhttp3_14.Request.Builder getHttpRequestBuilder() {
        return httpRequestBuilder;
    }

    public void setHttpRequestBuilder(ext.feishu.oapi.okhttp3_14.Request.Builder httpRequestBuilder) {
    ...
    public ext.feishu.oapi.core.api.response.Response<O> getResponse() {
        return response;
    }

    public void setResponse(ext.feishu.oapi.core.api.response.Response<O> response) {
