...
import ext.feishu.oapi.core.card.Card;
import ext.feishu.oapi.core.card.CardServlet;
...
public class CardController extends CardServlet {
    ...
    public void init() {
        Card.setHandler(this.getConfig(), new IHandler() {
            ...
            @Override
            public Object handle(Context context, ext.feishu.oapi.core.card.mode.Card card) throws Exception {
                // Print message card
                log.info("card:{}", card);
